...
public class TAddToCart extends LoadTestCase
{
     ...
     * random product's detail view and add it to cart.
     * 
    ...
    public void test() throws FlowStoppedException
    {
        ...
        // dev.properties.
        final int targetCartItemCount = Context.configuration().addToCartCount.value;

        while (Context.get().data.totalAddToCartCount < targetCartItemCount)
        {
