...
/**
 * Extending XLT's CustomData but sets the start time at object creation and
...
public class CustomData extends com.xceptance.xlt.api.engine.CustomData
{
    ...
    /**
     * Creates a new CustomData object and sets the given name. Furthermore, the
     * start time attribute is set to the current time.
     * 
