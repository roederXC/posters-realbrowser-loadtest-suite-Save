...
public class SelenideUtil
{
    ...
    /**
     * Scrolls to the top of the current age and accounts for the height of the
     * provided header element.
     * 
     * @param fixedHeader The header element's size will be accounted for in the
     *                    scrolling position
     */
     ...
     * 
     * Adjust the scrolling position by an offset to e.g. account for sticky headers
     * or similar.
     * 
     * @param elementToScrollIntoView The element to scroll into view
     * @param alignToTopOfElement     True the scrolling position should align with
     *                                the top of the element or in case of false
     *                                with the bottom
     ...
     * Scrolls element into view.
     * 
     * Considers the height of the given fixed header element in the scrolling
     * position.
     * 
     * @param elementToScrollIntoView The element to scroll into view
     * @param alignToTopOfElement     True the scrolling position should align with
     ...
     * 
     * Will check for existence, then scroll the element into view and later check
     * for visibility. Scrolls to the top of the element.
     * 
     * @param element   The element to validate
     * @param topOffset An offset to the top of the page, to e.g. account for sticky
     *                  headers
     ...
     * Validates if the given element is clickable.
     * 
     * Will check for existence, then scroll the element into view including
     * accounting for the height of the given fixed header and later check for
     * visibility.
     * 
     * @param element     The element to validate
     * @param fixedHeader The fixed header element which height is accounted for
     *                    during scrolling
     * @return The element that was validated
     */
     ...
     * Validates if the given element is clickable.
     * 
     * Will check for existence, then scroll the element into view and check for
     * visibility.
     * 
     * @param element The element to validate
     * @return The element that was validated
     ...
     * 
     * Will check for existence, then scroll the element into view account for the
     * element specified via the given cssLocator and check for visibility.
     * 
     ...
     * @param validationSizeGreaterOrEqual The minimal expected size of the
     *                                     collection
     ...
     * Randomly chooses an element from the given element collection.
     * 
     * Validates if the collection has at least the given size and provides the
     * option to ignore the first element.
     * 
     * @param collection                   The elements collection to chose from
     * @param validationSizeGreaterOrEqual The minimal expected size of the
     *                                     collection
     * @param ignoreFirst                  If true the first element of the
     ...
     * Randomly chooses an element from the given element collection.
     * 
     * Chooses between the given first and last element indices. Validates the size
     * of the elements collection via the given last element index.
     * 
     * @param collection The elements collection to chose from
    ...
    public static void injectJavascriptPopupBlocker()
    {
        final String popupBlocker = "function popupBlocker()" + "{"
                ...
                + "   var pdp = document.querySelector('.fancybox-overlay a.fancybox-close');" + "   if(pdp != null)"
                + "   {" + "       pdp.click();" + "       console.log('Popup closed');" + "	}" + "}" + ""
